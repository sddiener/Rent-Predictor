...
def immonet_parser(page_source):
    ...
    for i, selObject in enumerate(selObjects):  # extract info from apartments
        ...
        try:
            ...
            print('- Error extracting title (selObj {}/{}): {}'.format(i,
                  len(selObjects)-1, e))
        ...
        try:
            ...
            print(
                '- Error extracting bullets (selObj {}/{}): {}'.format(i, len(selObjects)-1, e))
        ...
        try:
            ...
            print('- Error extracting price (selObj {}/{}): {}'.format(i,
                  len(selObjects)-1, e))
        ...
        try:
            ...
            print('- Error extracting area (selObj {}/{}): {}'.format(i,
                  len(selObjects)-1, e))
        ...
        try:
            ...
            print('- Error extracting rooms (selObj {}/{}): {}'.format(i,
                  len(selObjects)-1, e))
...
for state in range(1, 17):  # loop 16 federal states
    ...
    while True:
        ...
        url = 'https://www.immonet.de/immobiliensuche/sel.do?suchart=1&state=1&marketingtype=2'\
              '&pageoffset=1&parentcat=1&sortby=19&listsize=26&objecttype=1&federalstate={}&page={}'.format(
                  state, page)
        ...
        df.to_csv(
            'downloads/state_{}/immo_data_state{}_page{}.csv'.format(state, state, page))
        # time.sleep(0.25)
